...
![webdef](/img/webantesdemodificar.png)

Configura de red:
![configred](/img/config%20de%20red.png)

Configura el firewall para permitir tráfico HTTP y HTTPS:
![confifirewall](/img/configfirewall.png)

Comprueba que el servicio está activo:
![status](/img/statusnginx.png)

Copia los archivos del sitio de ejemplo
![scp](/img/scpdelosarchivos.png)

Desactiva el sitio por defecto y activa tu configuración
![config](/img/desactivardefyactisonfig.png)

Accede desde el host a http://localhost:8082 y comprueba navegación, imágenes y estilo.
![webmod](/img/wendepuesmod.png)

Estructura de archivos
![estruct](/img/estructuradearchivo.png)
